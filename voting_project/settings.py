...
ALLOWED_HOSTS = ['college-voting-portal.onrender.com', '127.0.0.1']
...
# === Static/Media Files for Render and Whitenoise ===
STATIC_URL = '/static/'
...
# EMAIL SETTINGS (secure with env vars for Gmail or SMTP)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('discovervotigpotal2@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('epojyzhyjyuscnab')
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
SERVER_EMAIL = EMAIL_HOST_USER
EMAIL_TIMEOUT = 60

ADMINS = [
    ('Admin', os.environ.get('ADMIN_EMAIL', EMAIL_HOST_USER)),
]
MANAGERS = ADMINS
